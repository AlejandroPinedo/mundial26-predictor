        ...
        <div className="bg-gray-900/60 border border-gray-800 rounded-3xl p-8 backdrop-blur-md shadow-2xl">
          <div className="mb-6">
            ...
            <p className="text-gray-400 text-xs mt-1">
              Accede a tus predicciones del Mundial 2026
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 mb-6">
            <a href={`${API}/auth/google`}
              className="flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-900 font-bold py-3 rounded-2xl text-sm transition-all cursor-pointer">
            ...
            <a href={`${API}/auth/github`}
              className="flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-700 text-white font-bold py-3 rounded-2xl text-sm transition-all cursor-pointer border border-gray-700">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-gray-600 text-xs font-bold uppercase tracking-widest">o con email</span>
            <div className="flex-1 h-px bg-gray-800" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              ...
              <input
                className="bg-gray-950 border border-gray-800 text-white px-4 py-3 rounded-2xl text-sm outline-none focus:border-yellow-400/50 transition-colors"
            ...
            <button type="submit" disabled={loading}
              className="bg-yellow-400 hover:bg-yellow-300 text-gray-950 font-black py-3.5 rounded-2xl text-sm transition-all uppercase tracking-wider font-barlow cursor-pointer disabled:opacity-50 mt-2">
