        ...
        <div className="flex justify-between items-center mb-6 gap-4 flex-wrap">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1 font-sans">
              Compite contra toda la comunidad del Mundial 2026.
            </p>
          </div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-gray-500 bg-gray-900 border border-gray-800 px-3 py-1.5 rounded-full select-none font-sans">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex gap-16 items-center flex-shrink-0">
                        ...
                        <span className={`w-16 text-right font-barlow font-black text-xl ${
                          idx === 0 ? 'text-yellow-400' : idx === 1 ? 'text-slate-350' : idx === 2 ? 'text-amber-500' : 'text-white'
                        }`}>
