  ...
  return (
    <div className="min-h-screen bg-ink-950 flex items-stretch font-sans overflow-hidden">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] relative overflow-hidden p-12 bg-ink-900 border-r border-white/5">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full border border-mx/40" aria-hidden="true" />
        {/* Reflector verde */}
        <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-[520px] h-[380px] bg-mx/10 rounded-full blur-[120px]" aria-hidden="true" />
        ...
        <div className="relative z-10">
          <p className="font-display text-6xl text-white leading-[0.95] mb-5 uppercase">
            Unirse a<br />
            <span className="text-mx">La Porra</span><br />
            Global
          </p>
        ...
        <div className="relative z-10 space-y-3">
          {['Predice todos los partidos', 'Crea grupos con amigos', 'Completa tu bracket de playoffs'].map(f => (
            <div key={f} className="flex items-center gap-2.5 text-sm text-gray-400">
              <span className="w-5 h-5 rounded-full bg-mx/10 border border-mx/30 flex items-center justify-center flex-shrink-0">
                <Icon name="check" size={11} className="text-mx" strokeWidth={3} />
              </span>
              {f}
            </div>
          ))}
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 lg:p-12 relative bg-ink-950">
        ...
        <div className="w-full max-w-sm relative fade-up">
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 border border-mx/25 bg-mx/5 rounded-full px-3 py-1 mb-4">
              <span className="w-1.5 h-1.5 rounded-full bg-mx live-dot" />
              <span className="text-mx text-[10px] font-condensed font-extrabold uppercase tracking-[0.18em]">Registro gratuito</span>
            </div>
            <h1 className="font-display text-5xl md:text-6xl text-white leading-none uppercase">Unirse</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div>
              <label className="text-[10px] text-gray-500 uppercase tracking-[0.18em] font-condensed font-extrabold block mb-1.5">Usuario</label>
              <input
                className="w-full bg-white/[0.04] border border-white/10 focus:border-gold/40 text-white px-4 py-3.5 rounded-xl text-sm outline-none transition-all placeholder-gray-600"
