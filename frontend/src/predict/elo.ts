// Elo en vivo: parte del snapshot de ratings.ts y pliega los resultados ya jugados
// del Mundial usando la MISMA fórmula eloratings.net que ml/elo.py (paridad de escala).
// Mantener sincronizado con ml/elo.py.
import { ELO_RATINGS, getElo, HOST_NATIONS } from '../utils/ratings'

export const HOME_ADVANTAGE = 100
const WORLD_CUP_K = 60 // índice de peso K para partidos de Copa del Mundo (eloratings.net)
...
export function updateElo(
  eloHome: number, eloAway: number, homeGoals: number, awayGoals: number,
