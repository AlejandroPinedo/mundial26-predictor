...
// Iconos de trazo (estilo lucide). Heredan color via currentColor,
// por lo que NO llevan .no-invert: se invierten junto al texto en modo claro.
const paths: Record<string, ReactNode> = {
  ...
  ball: (
    <>
      ...
      <path d="M12 8V2M15.8 10.76 21.5 8.9M14.35 15.24 17.9 20.1M9.65 15.24 6.1 20.1M8.2 10.76 2.5 8.9" />
    </>
  ),
  trophy: (
    <>
